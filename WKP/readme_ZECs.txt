...
analyses to run (if larger than 25MB, these may be zipped); if you wish to 
re-run the processing simply copy the raw, unzipped files to the inputs folder
within the appropriate ISO/RTO folder.
